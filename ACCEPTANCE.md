...
- Measure the actual internal clearances, wire bends, screwdriver access and lid service slack against the [controlled body/pose envelopes](pcb/ASSEMBLY.md#body-and-courtyard-evidence). Include J_EARTH's full courtyard and body overhang of **1.00 mm nominal, 1.30 mm including pose/routed-edge tolerance**. External box dimensions do not establish a universal wall-clearance margin. Close the lid fully without pressing on SMT bodies/joints, displacing axial earth GDTs, straining LED leads or trapping the gasket. Record actual seating, body/lead and lid clearances, including solder seating height, and reinspect after closure/re-entry. No retired AC overpass-height gauge applies; earth-GDT forming and complete assembly fit remain required.
