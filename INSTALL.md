...
First dry-fit a complete prototype. Do not drill or prepare all lids until that fit and the process have been accepted. [pcb/ASSEMBLY.md](pcb/ASSEMBLY.md) controls hole, pin-pattern, body and forming limits; [pcb/DFM_EVIDENCE.md](pcb/DFM_EVIDENCE.md) preserves supporting evidence and historical parts. The current design specifies **16 electrical parts, six SMT and ten THT**, plus four mounting footprints. R1/R2 are **Vishay BCcomponents PR02000202201FA100**, copper-lead 2.2 kohm / 2 W / 1% / +/-250 ppm/K, with 0.83 mm maximum leads, retained 15.24 mm pitch and 1.40/2.40 mm holes/pads. D1-D4 are **Vishay General Semiconductor BYG23T-M3/TR**, SMA, not the retired through-hole 1N4007G. Controlled envelopes and design counts are not native-check results, accepted lots or assembled hardware.
...
The updated PR02/BYG23T model's **4.090396 mA nonuniform far-end LED corner at 35 V** includes a 5.2 V combined forward-drop screen and 50 uA conditional clamp diversion. It is not an exhaustive minimum, measurement or guaranteed brightness. At **40.39597 V**, zero drops and PR02 Rmin, the upper screen is **19.047268 mA / 0.769432871 W per resistor**, or **1.561875985 A / 63.0935 W for 82 branches with zero cable resistance**. Actual source limits, thermal interfaces and 5 m daylight results remain unqualified. The selected 2 W resistors still generate about 0.50 W each at the nominal comparison point; no OneGel thermal test has been performed.
