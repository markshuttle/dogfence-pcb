...
After receiving the prototypes, first dry-fit a complete assembly. Do not drill or prepare all lids until that fit and the process have been accepted. Use the reviewed [PCB BOM](pcb/BOM.csv), [placement and assembly controls](pcb/ASSEMBLY.md#placement-and-polarity) and [DFM evidence](pcb/DFM_EVIDENCE.md) for received-part identity, lands, retained holes, pin-pattern, body and GDT-forming limits.

The prototype uses 2512 SMT resistors and SMA diodes, with **no resistor/diode insertion holes or axial-resistor standoff/forming**. The retained **project-alternative resistor lands differ from TE's recommendation** and require supplier placement/stencil/solder acceptance; body fit is not an exact land-pattern match. Yageo needs [separate review and controlled source updates](ORDERING.md#7-prototype-acceptance-and-later-orders): neither its order nor TE testing authorizes substitution. Controlled envelopes are not accepted lots or assembled hardware.
