...
TE prototype results do not qualify Yageo thermal behavior. Before production release, separately review the ordered production part, update the controlled BOM/CAD, libraries, models and notes and reverify as specified in [ORDERING](ORDERING.md#7-prototype-acceptance-and-later-orders). Neither the order nor prototype testing authorizes a field substitution.
...
After receiving the prototypes, first dry-fit a complete assembly. Do not drill or prepare all lids until that fit and the process have been accepted. [pcb/ASSEMBLY.md](pcb/ASSEMBLY.md) controls SMT lands, retained holes, pin-pattern, body and GDT forming limits; [pcb/DFM_EVIDENCE.md](pcb/DFM_EVIDENCE.md) preserves supporting evidence and historical parts. The authorized design specifies **16 electrical parts, eight SMT and eight THT**, plus four mounting footprints. R1/R2 are selected **TE Connectivity 35212K2FT / [C4129105](https://jlcpcb.com/partdetail/C4129105)**, 2512 SMT, 2.2 kohm / 2 W / 1%, AEC-Q200 for the prototype BOM. Its body fits the retained envelope, but the unchanged **alternate project lands differ from TE's recommendation** and require supplier placement/stencil/solder acceptance. There are **no resistor holes, axial standoff or lead forming**. D1-D4 remain **Vishay General Semiconductor BYG23T-M3/TR**, SMA. The old 1N4007G/MBE/PR02 selections are retired; prior HP122WF2201T4E sourcing is superseded, not ordered; prior Uni-Royal PS12 order was cancelled/refunded. Controlled envelopes and design counts are not native-check results, accepted lots or assembled hardware.
...
Use the [TE-prototype / BYG23T model](pcb/DESIGN_BOUNDS.md) for the resistance envelope, nonuniform far-end current and upper current/power screens, not retired PS12/PR02 numbers or unreviewed Yageo extrapolations. Its 25 C resistance reference and -30..125 C screen are engineering assumptions, not verified TE TCR test conditions. These are conditional calculations, not measured source limits, exhaustive minimum current or guaranteed brightness. Nominal resistor heat remains about **0.50 W each**. Applying TE's 2 W P70/derating to this two-layer board is conditional on mounting/thermal evidence; the cited four-layer reference neither qualifies this assembly nor proves two-layer failure. SMT does not lower the loss or prove cooler operation. Actual thermal interfaces and 5 m daylight results remain unqualified, and no OneGel thermal test has been performed.
