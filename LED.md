...
The authorized **16-part HP12/BYG23T hybrid is not yet qualified hardware**. R1/R2 are intended **Uni-Royal HP122WF2201T4E**, HP12 / 2512 SMT, **2.2 kohm / 2 W / 1% / +/-100 ppm/C referenced to 25 C**, with sourcing pending and no guessed code; [MATERIALS](MATERIALS.md) records the rejected C2791283 mapping. D1-D4 remain **Vishay General Semiconductor BYG23T-M3/TR / C145454**: D1/D2 series; D3/D4 **negative shunts**, cathode to each LED positive/anode to B, downstream of the series diodes. The old 1N4007G/MBE0414/PR02 are retired design selections, not default replacements.

Gate P authorizes file-verified prototype artifacts with qualification holds deferred, not closed; it is not LED qualification, upload or order approval. Unresolved HP12 sourcing still blocks publication. Supplier CAM/placement/allocated parts precede any separately authorized order; original A/B/C production/field holds remain.
...
- [Vishay BYG23T-M3, 89429, 25-Feb-2020](https://www.vishay.com/docs/89429/byg23t.pdf) and [Uni-Royal HP Series, SMD-SP-003 V.7, 08-Jan-2026](https://www.uni-royal.cn/en/images/userfile/file/1784806233a2e6d381ea80b5d9.pdf), with test conditions, limitations and retired PR02 evidence recorded in [DESIGN_BOUNDS](pcb/DESIGN_BOUNDS.md).
