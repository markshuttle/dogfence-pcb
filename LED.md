...
The authorized **16-part SMT-resistor/BYG23T hybrid is not yet qualified hardware**. R1/R2 are selected **TE Connectivity 35212K2FT / [C4129105](https://jlcpcb.com/partdetail/C4129105)**, 2512 SMT, **2.2 kohm / 2 W / 1% / +/-100 ppm/C, AEC-Q200 qualified**, for the prototype BOM only (in stock at JLCPCB). [MATERIALS](MATERIALS.md) records the user-confirmed **Yageo SR2512FK-7W2K2L / [C876850](https://jlcpcb.com/partdetail/C876850)** order with an advised 20-day wait for future production, not receipt or allocation. The prior Uni-Royal PS12 order was cancelled/refunded due to stockout; its historical 110-part order remains in that ledger. Prior HP122WF2201T4E External sourcing is superseded, not ordered; C2791283 remains rejected HP122WJ0472T4E, 4.7 kohm / 5% history. D1-D4 remain **Vishay General Semiconductor BYG23T-M3/TR / C145454**: D1/D2 series; D3/D4 **negative shunts**, cathode to each LED positive/anode to B, downstream of the series diodes. The old 1N4007G/MBE0414/PR02 are retired design selections, not default replacements.

Gate P authorizes file-verified prototype artifacts with qualification holds deferred, not closed; it is not LED qualification, upload or order approval. In-stock 35212K2FT / C4129105 resolves resistor sourcing for the prototype order, not any file check or allocation; whole-BOM `allocation_verified` remains `false`. Unresolved external rows still block both publication modes. Use [REMEDIATION](REMEDIATION.md) for the latest file/publication results. Supplier CAM/placement/allocated parts precede any separately authorized order; original A/B/C production/field holds remain.

TE prototype results do not establish Yageo thermal qualification. Production release requires separate exact-part review, controlled BOM/CAD, library, model and note updates, and reverification under [ORDERING](ORDERING.md#7-prototype-acceptance-and-later-orders), not an automatic substitution when the order arrives.
...
Prefer evaluated optical/mounting improvements before increasing current. Lowering resistance or increasing supply voltage requires renewed near-source current, continuous potted thermal, fault/protection and procurement checks. Prototype TE resistors still dissipate about **0.50 W each** at the nominal comparison point; use [DESIGN_BOUNDS](pcb/DESIGN_BOUNDS.md#thermal-screens) for upper power and conditional derating. TE's 2 W P70/155 C zero-power curve uses a four-layer mounting/thermal reference, not this two-layer board; its transfer needs evidence, not an assumption of either success or failure. The retained alternate project lands also need supplier placement/stencil/solder acceptance under [ASSEMBLY](pcb/ASSEMBLY.md). SMT does not reduce loss or prove cooler OneGel operation; PR02 standoff/thermal examples and PS12 pulse curves do not apply. **Continuous-safe normal TEST remains mandatory without a timer**; no closed/gel-filled thermal test has been performed.
...
- [Vishay BYG23T-M3, 89429, 25-Feb-2020](https://www.vishay.com/docs/89429/byg23t.pdf), [TE Connectivity 3521 Series, Data Sheet 9-1773463-5, Rev G, 02/2025](https://www.te.com/commerce/DocumentDelivery/DDEController?Action=showdoc&DocId=Data+Sheet%7F9-1773463-5%7FG1%7Fpdf%7FEnglish%7FENG_DS_9-1773463-5_G1.pdf), [JLCPCB C4129105](https://jlcpcb.com/partdetail/C4129105). Test conditions, limitations and historical PS12/HP12/PR02 evidence are recorded in [DESIGN_BOUNDS](pcb/DESIGN_BOUNDS.md); the cited TE sheet does not establish the historical PS12 five-second overload test or transfer its pulse curves.
