...
| **Panel LED Indicators** | IP67 Green LED Panel Indicator (10mm mount, 2V standard version) | 80 | **APEM `Q10F5SXXSG02E`** | ⏳ **PENDING (Swap from 24E)** | 2 per box. Powered via PCB's heavy-duty 6.8kΩ resistor. |
...
| **Silicone Potting Gel** | Re-enterable two-part silicone encapsulation gel (~150–200ml per box) | ~6–8 Litres | **WISKA MP0100** | ✅ **ORDERED** | Submersible IP68 hermetic seal. Poured into WISKA boxes after wiring & testing. |
...
* **Milestone LEDs:** ✅ **Complete** (80× APEM `Q10F5SXXSG24E` ordered)
* **Board Standoffs:** ✅ **Complete** (160× Essentra `LCBSBM-6-01A-RT` ordered)
* **PCBA Manufacturing:** ✅ **Complete** (40× JLCPCB/PCBWay boards ordered)
