...
| GDT_AC | Same top-side Ruilon SMT pattern as GDT_AB/BC, internally north-south at the retained origin/0-degree angle; pad 1 A north, pad 2 C south. Review the actual SMT model/seating, not the retired Bencent model or axial height gauge. B crosses on the rear layer. |
