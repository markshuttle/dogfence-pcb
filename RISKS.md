...
| :--- | :--- |
| Impulse sparkover and residual voltage | A nominal 470 V GDT is not a 470 V transient clamp. Reviewed data at 1 kV/us gives up to **950 V** for SMD5050-470NA at all three inter-core positions, including GDT_AC, and **1100 V** for the 2R470TD-8 earth GDTs. Retired Bencent data does not bound the current AC part. Include lead/trace inductive overshoot and the final protected-load voltage. |
...
| Physical construction | Breaching the [layer-specific physical guardrails](pcb/ASSEMBLY.md#physical-guardrails) can weaken a discharge path or short conductors. Preserve A/C main rails on both faces, the exactly 6.00 mm rear B main rail, the front-B stop/rear-return geometry, all protected vias and EARTH copper/isolation. The **>=3.00 mm A/B/C inter-core rule applies to B.Cu only**; its nominal clearance does not qualify impulse insulation. GDT_AC is now SMT, not a formed overpass. Actual seating, body/electrode/fillet limits, laminate integrity and contamination still matter. |
...
[Assembly controls](pcb/ASSEMBLY.md#physical-guardrails) and [DFM evidence](pcb/DFM_EVIDENCE.md) distinguish body boxes, SMT lands and retained holes from actual fit. TE body containment does not approve its [alternate project lands](pcb/ASSEMBLY.md#2512-smt-resistors); supplier placement/stencil/solder acceptance remains required. No resistor/diode/AC insertion holes or axial resistor/AC forming/standoff remain. Retained Kefa [E limits](pcb/ASSEMBLY.md#hole-fit-evidence) are procurement envelopes, not guaranteed or measured lots; **W4 actual pin/pattern/body fit and solder/earth-GDT-forming acceptance remain open**. **W1 retains the Ruilon metric/inch contradiction and actual solder/stencil/CAM acceptance at all three SMT GDT positions**, alongside TE/BYG23T process review. File choices do not authorize further guardrail changes, folded routing or extra vias, or close production/field holds.

The SMT GDT_AC crossing separates front A/C copper from rear B through
**nominal 1.440 mm FR-4**, not the retired 2.00 mm raised air-gap construction.
That stackup model is neither a guaranteed finished dielectric minimum nor
qualified impulse insulation. Solder mask, a sleeve/tape or gel supplies no such
approval. Inspect actual post-assembly workmanship and qualify the intended
insulation/transient paths under [ACCEPTANCE](ACCEPTANCE.md#qualified-fault-tests).
The SMT body's **5.21 mm height maximum before solder seating** is not an assembled
height or COMBI-fit guarantee. There is no AC forming/height-gauge task; the
three earth GDTs still need accepted axial forming, and **W5's remaining
forming, support/enclosure and material/process holds stay open**. Supplier
manufacturing-process acceptance remains an order task; full COMBI dry-fit follows
prototype receipt before enclosure/field acceptance, not before Gate P files.
...
| Supports and fit | Essentra **LCBSBM-6-01A-RT** nominal hole/panel/spacing data must be checked against finished board tolerances, COMBI 308's PP substrate, adhesive instructions and retention. Use the [current J_EARTH edge/body/pose and courtyard controls](pcb/ASSEMBLY.md#earth-terminal-edge-clearance) with the revised outline/mounts; nominal in-board margins and a bare-board rectangle are not enclosure-fit approval. Complete dry-fit includes WAGOs, glands, cable bends, earth wires, complete GDT height, lid LEDs and screwdriver access. Do not assume gel permanently carries the PCB after adhesive failure. |
